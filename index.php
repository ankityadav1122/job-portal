  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <!-- logo for regular state and mobile devices -->
		<span class="logo-lg"><b>Online</b> <b>Job</b> Portal</span>
    </a>
  ...
  <div class="content-wrapper" style="margin-left: 0px;">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center index-head">
            <h1 style="color:white";>All <strong>JOBS</strong> In One Place</h1>
        ...
        <div class="row">
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              <img src="img/images.png" alt="Browse Jobs">
              <div class="caption">
          ...
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              <img src="img/1413830260-interview-questions.jpg" alt="Apply & Get Interviewed">
              <div class="caption">
          ...
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              <img src="img/Future-just-ahead.jpg" alt="Start A Career">
              <div class="caption">
    ...
    <section id="about" class="content-header">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6">
            <img src="img/1121.png" class="img-responsive">
          </div>
          <div class="col-md-6 about-text margin-bottom-20">
            <p>Online job portal is an easy way to find your dream job.
				we here at Online Job Portal work to provide you your dream job in an easy way.
				get your dream job .
            </p>
            <p>
